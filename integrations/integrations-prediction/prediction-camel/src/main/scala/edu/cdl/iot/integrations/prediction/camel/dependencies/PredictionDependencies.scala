package edu.cdl.iot.integrations.prediction.camel.dependencies
...
import edu.cdl.iot.integrations.prediction.cassandra.repository.{PredictionCassandraProjectRepository, PredictionCassandraSensorDataRepository, PredictionCassandraSensorRepository}
import edu.cdl.iot.integrations.prediction.core.service.PredictionService
