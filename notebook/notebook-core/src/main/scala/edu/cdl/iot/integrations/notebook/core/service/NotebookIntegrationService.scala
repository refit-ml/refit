...
import edu.cdl.iot.integrations.notebook.core.repository.{NotebookImportRepository, NotebookModelRepository, NotebookOrganizationRepository, NotebookPredictionRepository, NotebookProjectRepository, NotebookSchemaRepository, NotebookSensorRepository, NotebookTrainingWindowRepository}
